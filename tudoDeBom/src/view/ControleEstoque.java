...
public class ControleEstoque {
	...
	ControleEstoque() {
		...
		Object[] column = { "Código", "Nome", "Estoque", "Preço", "Categoria", "Disponibilidade", "Remédio",
				"Genérico", "Preço Descontado" };
		...
		btnCadastrar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (tfNomeProduto.getText().equals("") || tfPreco.getText().equals("")) {
					...
					if(cbGenerico.isSelected()) {
						objetoProduto.setPrecoDescontado(preco - (preco * 0.2));
					}else {
						objetoProduto.setPrecoDescontado(0);
					}
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (cbDisponibilidade.isSelected()) {
					...
					produtoDao.listaProdutosDisponibilidade(true);
					listaProdutosDisponibilidade();
				} else if (cbRemedio.isSelected()) {
					ProdutoDAO produtoDao = new ProdutoDAO();
					produtoDao.listaProdutosRemedios(true);
					listaProdutosRemedios();
				} else if (cbGenerico.isSelected()) {
					ProdutoDAO produtoDao = new ProdutoDAO();
					produtoDao.listaProdutosRemedios(true);
					listaProdutosGenericos();
				}
				else {
					listarProdutos();
				}
		...
		try {
			...
			for (int num = 0; num < lista.size(); num++) {
				model.addRow(new Object[] { lista.get(num).getId(), lista.get(num).getNome(),
						lista.get(num).getEstoque(), lista.get(num).getPreco(), lista.get(num).getCategoria(),
						lista.get(num).getDisponibilidade(), lista.get(num).getRemedio(), lista.get(num).getGenerico(), lista.get(num).getPrecoDescontado() });
			}
		} catch (Exception e) {
	...
	private void listaProdutosDisponibilidade() {
		try {
			ProdutoDAO objetoProdutoDAO = new ProdutoDAO();
			DefaultTableModel model = (DefaultTableModel) table.getModel();
			model.setNumRows(0);
			...
			for (int num = 0; num < lista.size(); num++) {
				if (lista.get(num).isDisponibilidade() == true) {
					model.addRow(new Object[] { lista.get(num).getId(), lista.get(num).getNome(),
							lista.get(num).getEstoque(), lista.get(num).getPreco(), lista.get(num).getCategoria(),
							lista.get(num).isDisponibilidade(), lista.get(num).isRemedio(),
							lista.get(num).isGenerico(), lista.get(num).getPrecoDescontado() });
	...
	private void listaProdutosRemedios() {
		try {
			ProdutoDAO objetoProdutoDAO = new ProdutoDAO();
			DefaultTableModel model = (DefaultTableModel) table.getModel();
			model.setNumRows(0);
			...
			for (int num = 0; num < lista.size(); num++) {
				if (lista.get(num).isRemedio() == true) {
					model.addRow(new Object[] { lista.get(num).getId(), lista.get(num).getNome(),
							lista.get(num).getEstoque(), lista.get(num).getPreco(), lista.get(num).getCategoria(),
							lista.get(num).isDisponibilidade(), lista.get(num).isRemedio(),
							lista.get(num).isGenerico(), lista.get(num).getPrecoDescontado() });
	...
	private void listaProdutosGenericos() {
		try {
			ProdutoDAO objetoProdutoDAO = new ProdutoDAO();
			DefaultTableModel model = (DefaultTableModel) table.getModel();
			model.setNumRows(0);
			...
			for (int num = 0; num < lista.size(); num++) {
				if (lista.get(num).isGenerico() == true) {
					model.addRow(new Object[] { lista.get(num).getId(), lista.get(num).getNome(),
							lista.get(num).getEstoque(), lista.get(num).getPreco(), lista.get(num).getCategoria(),
							lista.get(num).isDisponibilidade(), lista.get(num).isRemedio(),
							lista.get(num).isGenerico(), lista.get(num).getPrecoDescontado() });
